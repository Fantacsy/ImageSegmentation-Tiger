function X = featureX(dataF, datG, img, zig, sigma_BG, mu_BG, p_BG, sigma_FG, mu_FG, p_FG, num_cluster)
[row, col] = size(img);
...
for i = 4 : newRow - 4
    for j = 4 : newCol - 4
        ...
        X(i - 3, j - 3) = predict(dataF, datG, dctValue, sigma_BG, mu_BG, p_BG, sigma_FG, mu_FG, p_FG, num_cluster);
    end
end